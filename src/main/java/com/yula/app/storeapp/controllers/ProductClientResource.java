...
public class ProductClientResource {
    ...
    private static final String GET_PRODUCT_BY_NAME_OR_DESCRIPTION_API = "http://localhost:8085/api/products/search/{keyword}";
    private static final String GET_ALL_PRODUCTS_API = "http://localhost:8085/api/products/";
    private static final String GET_PRODUCT_BY_ID_API = "http://localhost:8085/api/products/{id}";
